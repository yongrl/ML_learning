...
# 1. 最基本的特征
# Continuous columns. Wide and Deep 组件都会用到。
...
'''
1. Sparse Features -> Embedding Vectors -> 串联(Embedding vector,连续特征) -> 输入到Hidden Layer
2. Embedding Values 随机初始化
3. 另外一种处理离散特征的方法是: one-hot or multi-hot representation. 但是仅仅试用与维度较低的,embedding是更加通用的做法
